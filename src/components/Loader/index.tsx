...
export const StaticLoader: FunctionComponent<{ message?: string }> = ({
  ...
  return (
    <div className="absolute top-0 left-0 h-dvh w-dvw z-999 bg-background flex flex-col justify-center items-center">
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          key="loader"
          className="absolute top-0 left-0 h-dvh w-dvw z-999 bg-background flex flex-col justify-center items-center"
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          onAnimationEnd={() => {
